...
import IconsHomePage from "./IconsHomePage.vue";
...
function sendMail() {
  window.location.href = 'mailto:kharbach2320@gmail.com';
}

function openCV() {
  window.open('/portfolio/src/assets/Kharbach-Somia-CV-1.pdf', '_blank');
}
